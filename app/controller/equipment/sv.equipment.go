...
func (s *Service) Update(ctx context.Context, id int64, req request.UpdateEquipment) (*model.Equipment, bool, error) {
	ex, err := s.db.NewSelect().Model((*model.Equipment)(nil)).Where("id = ?", id).Exists(ctx)
	if err != nil {
